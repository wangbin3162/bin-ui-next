...
export { BAffix, BAlert, BAnchor, BAnchorLink, BBackTop, BBadge, BBreadcrumb, BBreadcrumbItem, BButton, BButtonGroup, BCard, BCircle, BCol, BCollapse, BCollapsePanel, BCollapseWrap, BCollapseTransition, BDivider, BEmpty, BIcon, BLoading, BProgress, BRow, BScrollbar, BSplit, BSteps, BStep, BTag, BTimeline, BTimelineItem, Message, Notice, };
export default {
    install,
};
